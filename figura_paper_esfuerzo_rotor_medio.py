...
con los rotores medios del stress del viento de
NCEP, CFSR, ERA y CCMPv2
Dani Risaro
Noviembre 2019
"""
...
for i in range(4):
    ...
    data_curl = data.svo.mean('time').values
    ...
    ccurl_line = plt.contour(lon_curl, lat_curl, matriz, clevs_curl_label, colors='k',
